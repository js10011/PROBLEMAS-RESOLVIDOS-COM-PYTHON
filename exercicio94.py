'''Crie um programa que leia dados de um arquivo Excel sobre transações de clientes. Execute a limpeza dos dados, incluindo a remoção de linhas com lacunas, remoção de duplicatas e conversão de colunas para os tipos de dados necessários. Formate a coluna de datas no formato 'yyyy-mm-dd'. Salve os dados formatados e limpos em um novo arquivo Excel. O programa deve exibir informações sobre o número de linhas removidas e os tipos de dados de cada 
coluna após a limpeza'''
import pandas as pd
