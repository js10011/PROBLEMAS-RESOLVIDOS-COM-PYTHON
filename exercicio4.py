...
em ordem alfabética.'''
paises = ['Russia', 'Grecia', 'Egito', 'Inglaterra', 'Noruega', 'Italia']
print(f'Paises que eu adoraria conhecer :{paises}\n')

'''Utilize sorted() para exibir sua lista em ordem alfabética'''
print(f'Lita em ordem\n{sorted(paises)}\n')
...
print(f'Lista em ordem alfabetica inversa : {paises}\n')
